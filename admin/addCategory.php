...
$view = 'addCategory';      //vue qui sera affichée dans le layout
$pageTitle = 'Ajoutez une catégorie!';  //titre de la page qui sera mis dans title et h1 dans le layout
...
try {
    ...
    /** On va récupérer les catégories dans la bdd pour afficher la liste des catégories parents*/
